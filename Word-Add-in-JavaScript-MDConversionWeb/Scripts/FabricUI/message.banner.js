...
(function () {
    ...
    var FabricComponents = window.FabricComponents || {};
  //  app.notification = {};
    ...
    $(document).ready(function () {
         ...
         * @constructor
         */
        FabricComponents.MessageBanner = function (container) {
            this.container = container;
            this.init();
        };

        FabricComponents.MessageBanner.prototype = CreatePrototype();
        ...
        $('.ms-MessageBanner').each(function () {
            new FabricComponents.MessageBanner(this);
        });
    ...
    window.FabricComponents = FabricComponents;
})();